<template>
  ...
  >
    ...
    <div class="relative mt-1">
      ...
      <ComboboxOptions v-if="!loading && result?.searchMovies?.length >= 1" class="absolute z-10 mt-1 max-h-72 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
